...
@login_required
def all_entries():
    # Gauti visus įrašus iš duomenų bazės (ne tik prisijungusio vartotojo)
    entries = Entry.query.all()  # Visi įrašai iš duomenų bazės
    return render_template('all_entries.html', all_entries=entries)
